...
//Application Title
define('APP_TITLE', 'Xcod3 Tiny File Manager');
...
$readonly_users = array(
    'user', 'users', 'guests', 'guest', 'root', 'toor'
);
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Xcod3 Tiny File Manager">
