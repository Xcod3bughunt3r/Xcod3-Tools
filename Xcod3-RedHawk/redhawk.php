...
if ($ip == "help")
  {
    ...
    echo $bold . $fgreen . "[3] URL:$cln Enter The Domain Name Which You Want To Scan (Format:www.itsecurity.id / itsecurity.id)\n";
        ...
        elseif ($scan == 'U' || $scan == 'u')
          {
            ...
            $latestversion = readcontents("https://raw.githubusercontent.com/Xcod3bughunt3r/Xcod3-Tools/Xcod3-RedHawk/master/version.txt");
