...
<head>
	<meta charset="UTF-8">
	<title>Xcod3 - Server Check PHP</title>
...
<body>
	...
	<footer>
		<div class="footer">
			...
			Built by <a href="https://www.itsecurity.id">ALIF FUSOBAR - Xcod3bughunt3r</a> | <a href="?json=1">JSON</a> | 🌙 <a href="javascript:void(0)" onclick="toggleDarkMode();">Dark Mode</a>
		</div>
	</footer>
<script>
