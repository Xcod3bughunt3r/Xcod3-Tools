...
File Mode:
python3 socker.py -i proxys_checked.txt
URL Mode:
...
python3 socker.py -i proxys_checked.txt -auto

socker is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Xcod3bughunt3r',
...
if __name__ == "__main__":
    ...
    if args.version:
        ...
        proxies = []
        proxy_api = [
            "https://raw.githubusercontent.com/Xcod3bughunt3r/Proxy-List/master/socks4.txt",
            "https://raw.githubusercontent.com/Xcod3bughunt3r/Proxy-List/master/socks5.txt"
        ]
        if args.input:
