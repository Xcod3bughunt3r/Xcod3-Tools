...
def intro1():
    ...
    print(f'{Fore.LIGHTRED_EX}  .////:`      ``-://///////-.`  `-///- {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX} `///////---::/::-.-:///:-`     .:///:` {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX} -/////:--..``` `.---.`      `.::-:/:`  {Style.RESET_ALL}{Fore.CYAN}Repo{Style.RESET_ALL}: https://github.com/Xcod3bughunt3r/AFXcod3')
    print(f'{Fore.LIGHTRED_EX} :///:.`..                `.:/:.`-/:`   {Style.RESET_ALL}{Fore.CYAN}Email{Style.RESET_ALL}: master@itsecurity.id') 
    ...
    print(f'{Fore.LIGHTRED_EX}  `////////////`    `:/` `-://////`     {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX}   `://////////.   `:/--:///////:`      {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX}    `-/////////` `.////////////.`       {Style.RESET_ALL}{Fore.BLUE}███{Fore.RED}███{Fore.GREEN}███{Fore.GREEN}███{Fore.LIGHTBLUE_EX}███{Fore.MAGENTA}███{Fore.CYAN}███{Fore.GREEN}███')
